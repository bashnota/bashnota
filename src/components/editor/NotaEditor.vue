...
import { JavaScriptCodeBlockExtension } from './extensions/JavaScriptCodeBlockExtension'
...
const editorExtensions = [
  ...
  UniqueId.configure({
    attributeName: 'id',
    types: ['executableCodeBlock', 'javascriptCodeBlock'],
  ...
  JavaScriptCodeBlockExtension.configure({
    HTMLAttributes: {
      class: 'code-block',
    },
    languageClassPrefix: 'language-',
