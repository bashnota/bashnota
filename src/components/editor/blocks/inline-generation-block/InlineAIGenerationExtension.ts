...
import type { RawCommands, Editor, CommandProps } from '@tiptap/core'

declare module '@tiptap/core' {
  interface Commands<ReturnType> {
    inlineAIGeneration: {
      insertInlineAIGeneration: () => ReturnType
      generateInlineAI: (nodePos: any, prompt: any, isContinuation?: boolean) => ReturnType
      deleteInlineAIGeneration: (pos: number) => ReturnType
    }
  }
}
